...
#import "ZMJActionSheet.h"

@interface ZMJActionSheet () <UIActionSheetDelegate>

@end

@implementation ZMJActionSheet
{
...
- (void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
	...
	ZMJActionSheetBlock block = [_actionsPerIndex objectForKey:key];
